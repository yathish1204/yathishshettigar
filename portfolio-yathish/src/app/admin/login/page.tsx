      ...
      <div className="flex items-center justify-center p-6 sm:p-10 md:p-16 h-full relative z-10">
        <div className="w-full  max-w-sm space-y-6 sm:space-y-8">
          <div className="flex gap-2 items-center space-y-2">
            <div className="w-12 h-12 rounded-2xl bg-[#B45309] text-white dark:bg-[#FBBF24] dark:text-zinc-950 font-mono text-xl font-extrabold flex items-center justify-center">
              YS
            </div>
            <h1 className="text-xl sm:text-2xl font-extrabold text-zinc-100 tracking-tight ml-2 mdml-4">Welcome Yathish</h1>
          </div>
