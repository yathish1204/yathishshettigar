...
export function CertificationsCarousel({ certifications }: { certifications: Certification[] }) {
  ...
  return (
    <>
      ...
      >
        {certifications.map((cert, idx) => (
          <div
            ...
            aria-label={`Certification ${idx + 1} of ${certifications.length}: ${cert.name}`}
      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-center gap-2 pt-6" role="tablist" aria-label="Certification carousel slides">
